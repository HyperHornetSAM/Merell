				...
				case 'racetrack':
					{
						...
						var sky:FlxSprite = new FlxSprite(-425, -650).loadGraphic(Paths.image('bg/Sky', 'shared'));
						sky.scrollFactor.set(0.2,0.2);
						sky.antialiasing = FlxG.save.data.antialiasing;
						add(sky);
						
						//var bleachers_back:FlxSprite = new FlxSprite(-425, -640).loadGraphic(Paths.image('bg/Bleachers', 'shared'));
						var bleachers_back:FlxSprite = new FlxSprite(-170, -340).loadGraphic(Paths.image('bg/Bleachers_no_rail', 'shared'));
						bleachers_back.scrollFactor.set(0.2, 0.2);
						bleachers_back.antialiasing = FlxG.save.data.antialiasing;
						bleachers_back.setGraphicSize(Std.int(bleachers_back.width * 0.6));
						bleachers_back.updateHitbox();
						add(bleachers_back);
						
						//upperBoppers = new FlxSprite(-310, 73);
						upperBoppers = new FlxSprite(-95, 88);
						upperBoppers.frames = Paths.getSparrowAtlas('bg/Funkers', 'shared');
						upperBoppers.animation.addByPrefix('bop', "Funkers", 24, false);
						upperBoppers.scrollFactor.set(0.2, 0.2);
						upperBoppers.setGraphicSize(Std.int(upperBoppers.width * 0.6));
						...
						//var bleachers_front:FlxSprite = new FlxSprite(-425, -640).loadGraphic(Paths.image('bg/Bleachers_Front', 'shared'));
						var bleachers_front:FlxSprite = new FlxSprite(-170, -340).loadGraphic(Paths.image('bg/Bleachers_Front', 'shared'));
						bleachers_front.scrollFactor.set(0.2, 0.2);
						bleachers_front.antialiasing = FlxG.save.data.antialiasing;
						bleachers_front.setGraphicSize(Std.int(bleachers_front.width * 0.6));
						bleachers_front.updateHitbox();
						add(bleachers_front);
						
						//var bleachers_rail:FlxSprite = new FlxSprite(-100, -340).loadGraphic(Paths.image('bg/Banner_Rail', 'shared'));
						var bleachers_rail:FlxSprite = new FlxSprite(-170, -340).loadGraphic(Paths.image('bg/Banner_Rail', 'shared'));
						bleachers_rail.scrollFactor.set(0.2, 0.2);
						bleachers_rail.antialiasing = FlxG.save.data.antialiasing;
						bleachers_rail.setGraphicSize(Std.int(bleachers_rail.width * 0.6));
						bleachers_rail.updateHitbox();
						add(bleachers_rail);
						
						//var road:FlxSprite = new FlxSprite(-425, -766).loadGraphic(Paths.image('bg/Road', 'shared'));
						var road:FlxSprite = new FlxSprite(-425, -726).loadGraphic(Paths.image('bg/Road', 'shared'));
						road.setGraphicSize(Std.int(road.width * .9));
						road.scrollFactor.set(0.2, 0.2);
						road.active = false;
						road.antialiasing = FlxG.save.data.antialiasing;
						//road.setGraphicSize(Std.int(road.width * 1.5));
						//road.updateHitbox();
						add(road);
						
						var grass:FlxSprite = new FlxSprite(-425, -640).loadGraphic(Paths.image('bg/Grass', 'shared'));

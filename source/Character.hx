...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		{
			case 'merell-jacket':
				tex = Paths.getSparrowAtlas('Merell Jacket','shared',true);
				frames = tex;
				animation.addByPrefix('idle', 'MerellJacketIdle', 24, false);
				animation.addByPrefix('singUP', 'Merell Jacket Up', 24, false);
				animation.addByPrefix('singRIGHT', 'Merell Jacket Right', 24, false);
				animation.addByPrefix('singDOWN', 'Merell Jacket Down', 24, false);
				animation.addByPrefix('singLEFT', 'Merell Jacket Left', 24, false);

				loadOffsetFile(curCharacter);

				playAnim('idle');
				
			case 'merell-nojacket':
				tex = Paths.getSparrowAtlas('MerellNoJacket','shared',true);
				frames = tex;
				animation.addByPrefix('idle', 'Merell Idle', 24, false);
				animation.addByPrefix('singUP', 'Merell Up', 24, false);
				animation.addByPrefix('singRIGHT', 'Merell Right', 24, false);
				animation.addByPrefix('singDOWN', 'Merell Down', 24, false);
				animation.addByPrefix('singLEFT', 'Merell Left', 24, false);
	...
	public function dance(forced:Bool = false, altAnim:Bool = false)
	{
		if (!debugMode)
		{
			switch (curCharacter)
			{
				case 'gf' | 'gf-christmas' | 'gf-car' | 'gf-pixel' | 'gf-jacket':
